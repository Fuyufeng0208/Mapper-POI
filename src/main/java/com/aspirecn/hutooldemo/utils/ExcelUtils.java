package com.aspirecn.hutooldemo.utils;

import com.aspirecn.hutooldemo.common.ExcelHead;
...
public class ExcelUtils {
    ...
    public static <T> List<T> readExcelToEntity(Class<T> classzz, InputStream in, String fileName) throws Exception {
        ...
        ExcelHead excelHead3 = new ExcelHead("家庭住址", "address");
        ExcelHead excelHead4 = new ExcelHead("出生日期", "birthday");
        ExcelHead excelHead5 = new ExcelHead("政治面貌", "outlook");
    ...
    public static void main(String[] args) {
        File file = new File("E:\\user.xlsx");
        ...
        try {
            ...
            excelHeads.add(excelHead4);
            excelHeads.add(excelHead5);
            List<User> list = ExcelUtils.readExcelToEntity(User.class, in, file.getName(), excelHeads);
